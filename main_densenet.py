...
def main():
    ...
    if not args.split:
        ...
        model_rank.load_state_dict(torch.load('ckpt_split/best_model_cifar10h_densenet_split1_mcls0_mccl0_hcls0_hccl0.pth.tar'))
        model_rank.eval()
    ...
    for epoch in range(1, args.num_epoch + 1):
        ...
        if accuracy > best_acc:
            ...
            torch.save(best_model.state_dict(), 'ckpt_split/best_model_cifar10h_densenet_split{}_mcls{}_mccl{}_hcls{}_hccl{}.pth.tar'.format(
    ...
    ckpt_name = 'best_model_cifar10h_split{}_mcls{}_mccl{}_hcls{}_hccl{}.pth.tar'.format(
                int(args.split), int(args.mcls), int(args.mccl), int(args.hcls), int(args.hccl))
    write_csv("results_densenet_CL.csv", ["init_prob:" + str(args.init_ratio), "epoch_iid:" + str(args.end_epoch),
