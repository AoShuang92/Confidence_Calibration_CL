...
def main():
    ...
    for epoch in range(args.num_epoch):
        ...
        if accuracy > best_acc:
            ...
            torch.save(best_model.state_dict(), 'ckpt_text/best_model_wikiart_split{}_mcls{}_mccl{}_hcls{}_hccl{}.pth.tar'.format(
    ...
    ckpt_name = 'best_model_wikiart_split{}_mcls{}_mccl{}_hcls{}_hccl{}.pth.tar'.format(
                int(args.split), int(args.mcls), int(args.mccl), int(args.hcls), int(args.hccl))
    write_csv("results_wikiart.csv", ["init_prob:" + str(args.init_ratio), "epoch_iid:" + str(args.end_epoch),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--smoothing', default = 0.11, type=float, help='ls smoothing')
